...
winningcondtionsrobot = [1, 2, 3] || [4, 5, 6] || [7, 8, 9] ||
...
# computer move, will randomly select a number from the remaining options array.this number will be removed from options
# array and added to its own output array.

puts 'player one has chosen 1, computer chooses 2.please choose from remaining options a3,b4,b5,b6,c7,c8,c9'
